                                ...
                                'options' => [
                                  ...
                                  //  'renderTo' => 'container',
                                    ...
                                    /*    [
                                            'type' => 'line',
                                            'name' => 'Ceragon',
                                            'data' => $array_PassPF_Ceragon,
                                            'color' => new JsExpression('Highcharts.getOptions().colors[1]'),
                                            'pointStart' => gmmktime(0, 0, 0, 3, 3, 2016) * 1000,
                                            'pointInterval' => 24 * 3600 * 1000 // one day
                                        ],
                                        [
                                            'type' => 'line',
                                            'name' => 'Flex1',
                                            'data' => $array_PassPF_Flex1,
                                            'color' => new JsExpression('Highcharts.getOptions().colors[2]'),
                                            'pointStart' => gmmktime(0, 0, 0, 3, 3, 2016) * 1000,
                                            'pointInterval' => 24 * 3600 * 1000 // one day
                                        ],
